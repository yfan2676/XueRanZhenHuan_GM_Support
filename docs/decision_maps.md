...
flowchart TD
    ...
    M --> N
    N -- 是 --> N2{年羹尧今夜被宠妃禁足?}
    N2 -- 是 --> N3[带人落空<br/>技能仍视为已消耗]
    N2 -- 否 --> O[年羹尧当晚带走一名玩家<br/>被带走者回到本流程 G 结算]
...
```mermaid
flowchart TD
    A[三阿哥夜晚选择左/右一名存活邻座] --> B{皇上同晚侍寝该目标<br/>且成功转化?}
...
> **捉奸只看侍寝**：皇上的刀口撞上三阿哥的染指目标不构成捉奸（巧合而已，三阿哥照常拿手势）；侍寝失败（男性目标 / 被果郡王免睡 / 皇上醉毒）同样不构成捉奸，两人各自失败。见 rules.md 三阿哥条目。
>
